...
import { Button, Col, Divider, Row, Space, Tabs, message } from 'antd';
...
export default () => {
  ...
  const onFinishFailed = (errorInfo: any) => {
    for (let i in errorInfo.errorFields) {
      messageApi
        .error(errorInfo.errorFields[i].errors[0])
      ...
      >
        ...
        {loginType === 'account' && (
          <>
            ...
            />
            <Row>
              <Col onClick={getCaptcha} span={12}>
                <img src={captcha} width={'100%'} />
              </Col>
              <Col span={10} push={2}>
                <ProFormText
                  name="code"
